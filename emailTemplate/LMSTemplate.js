...
const HesMail = async  (fullName, studentEmail, username, password) => {
    ...
    <div style="max-width: 700px; margin: auto; background-color: white;">
        ...
        <div style="padding: 0px !important; line-height: 40px !important; margin-top: 15px; font-size: 11px !important; font-weight: normal;">
            <table>
                <tbody>
                    <tr>
                        <td>Hello <strong>${fullName}</strong></td>
                    </tr>
                    <tr>
                        <td>Welcome onboard! You have successfully been added to Sikkim Professional University LMS</td>
                    </tr>
                    <tr>
                        <td>Your Username is: <span>${username}</span> & Password: ${password}</td>
                    </tr>
                    <tr>
